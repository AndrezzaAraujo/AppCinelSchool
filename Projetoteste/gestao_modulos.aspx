<%@ Page Title="" Language="C#" MasterPageFile="~/intranet.Master" AutoEventWireup="true" CodeBehind="gestao_modulos.aspx.cs" Inherits="Projetoteste.gestao_modulos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ProjetoFinal1ConnectionString %>" SelectCommand="SELECT * FROM [modulos]"></asp:SqlDataSource>
    <!-- Sessão Pesquisa -->
    <div class="filter-section">
        <div id="filterForm" runat="server">
            <div class="form-group" style="display: inline-block; width: 40%; margin: 30px 10px 0 0;">
                <asp:Label ID="lbl_search" runat="server" Text="Pesquisar Nome"></asp:Label>
            ...
            <div class="form-group" style="display: inline-block; width: 33%;">
                <asp:ImageButton ID="img_lupa" src="img/icon_search.png" alt="ícone do utilizador" Style="width: 25px; height: 25px; margin:10px 0 0 0;" OnCLick="img_lupa_Click" title="Pesquisar" runat="server"/>
                <asp:ImageButton ID="img_limpar" src="img/icon-eraser2.png" alt="ícone do utilizador" Style="width: 25px; height: 25px; margin:10px 0 0 0; margin-left: 30px;"  OnCLick="img_limpar_Click" title="Limpar" runat="server" />
            </div>
            <div class="form-group" style="display: inline-block; width: 33%;">                
            </div>
        </div>
   ...
   <div style="margin-bottom: 50px; display: flex; justify-content: center; margin-left:1165px;">
       <asp:Button ID="Button1" Text="RETORNAR PÁGINA" OnClick="Button1_Click" runat="server" Style="background-color: #F79E74; color: white; border: none; border-radius: 4px; padding: 7px 20px; margin: 15px 0px 5px 77px; left: 50%; bottom: 20px; transform: translateX(-50%); cursor: pointer; transition: background-color 0.3s;" onmouseover="this.style.backgroundColor='#FF7F50'" onmouseout="this.style.backgroundColor='#F79E74'" />
    </div>

     <div id="line-beside">
            <h1 style="margin:0 0 0 0"; >GESTÃO DE MÓDULOS</h1>
        <div class="line"></div>
     </div>
           ...
           <div style="margin-top: 40px; margin-left:100px;">
            ...
            <asp:Repeater ID="rpt_modulos" OnItemCommand="rpt_modulos_ItemCommand" OnItemDataBound="rpt_modulos_ItemDataBound" DataSourceID="SqlDataSource1" runat="server">
                <HeaderTemplate>
                ...
                <ItemTemplate>
                    <tr>
                        <td style=" text-align: center;">
                         ...
                         <td >
                            <asp:TextBox ID="tb_nomeModulo" runat="server"></asp:TextBox></td>
                        <td style=" text-align: center;">
                            <asp:TextBox ID="tb_duracao" style=" text-align: center;" runat="server"></asp:TextBox></td>
                        <td style=" text-align: center;">
                            <asp:TextBox ID="tb_numModulo" style=" text-align: center;" runat="server"></asp:TextBox></td>
                        <td style=" text-align: center;">
