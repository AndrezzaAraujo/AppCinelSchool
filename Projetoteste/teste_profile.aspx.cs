...
using System.Web;
using System.Web.UI;
using System.Web.UI.WebControls; // adicionado
...
{
    public partial class teste_profile : System.Web.UI.Page
    {
        ...
        // leitura da tabela/colunas
        //protected void rpt_documentos_ItemDataBound(object sender, RepeaterItemEventArgs e)
        //{
        ...
        //            // findControl commandargument lbl.text 
        //            //((Button)e.Item.FindControl("lbl_cod")).CommandArgument = dr["cod_documento"].ToString();
        //        }
        //    }
        //}

        //protected void rpt_documentos_ItemCommand(object source, RepeaterCommandEventArgs e)
        //{
        ...
        //        rpt_documentos.DataBind(); // está instruindo o controle a se atualizar com os dados da fonte de dados associada
        //    }
        //}
        ...
        //    //myCommand.Parameters.AddWithValue("@cod_documento", CodDocumento);
