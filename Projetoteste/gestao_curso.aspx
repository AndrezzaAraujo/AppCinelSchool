<%@ Page Title="" Language="C#" MasterPageFile="~/intranet.Master" AutoEventWireup="true" CodeBehind="gestao_curso.aspx.cs" Inherits="Projetoteste.gestao_curso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:SqlDataSource ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:ProjetoFinal1ConnectionString %>" SelectCommand="SELECT * FROM [cursos]" runat="server" ></asp:SqlDataSource>
  ...
  <script>
    ...
    <div class="filter-section">
        <div id="filterForm" runat="server">
            ...
            <div class="form-group" style="display: inline-block; width: 33%;">
                <asp:ImageButton ID="img_lupa" src="img/icon_search.png" alt="ícone do utilizador" Style="width: 25px; height: 25px; margin:10px 0 0 0;" runat="server" OnClick="img_lupa_Click" title="Pesquisar" />
                <asp:ImageButton ID="img_limpar" src="img/icon-eraser2.png" alt="ícone do utilizador" Style="width: 25px; height: 25px; margin:10px 0 0 0; margin-left: 30px;" runat="server" OnClick="img_limpar_Click" title="Limpar" />           
            </div>
            <div class="form-group" style="display: inline-block; width: 33%;">               
            </div>
        </div>
   ...
   <div style="margin-bottom: 50px; display: flex; justify-content: center; margin-left:1165px;">
       <asp:Button ID="btn_goPage" Text="RETORNAR PÁGINA" OnClick="btn_goPage_Click" runat="server" Style="background-color: #F79E74; color: white; border: none; border-radius: 4px; padding: 7px 20px; margin: 15px 0px 5px 77px; left: 50%; bottom: 20px; transform: translateX(-50%); cursor: pointer; transition: background-color 0.3s;" onmouseover="this.style.backgroundColor='#FF7F50'" onmouseout="this.style.backgroundColor='#F79E74'" /></div>

     <div id="line-beside">
            <h1 style="margin:0 0 0 0"; >GESTÃO DE CURSOS</h1>
        <div class="line"></div>
     </div>
         ...
         <div style="margin-top: 40px; margin-left:100px;">
             ...
             <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                 <ContentTemplate>
            <asp:Repeater ID="rpt_cursos" OnItemCommand="rpt_cursos_ItemCommand" OnItemDataBound="rpt_cursos_ItemDataBound" runat="server" DataSourceID="SqlDataSource1">
                <HeaderTemplate>
                    <table id="myTable" border="1" style="border-collapse: collapse" width="900">
                        <tr style="background-color: #e4e6df">
                            ...
                            <th style="text-align: center;"><b>Horario</b></td>
                            <th style="text-align: center;"><b>Local</b></td>
                            <th style="text-align: center;"><b>Tipo</b></td>
                            <th style="text-align: center;"><b>Área </b></th>
                            <th style="text-align: center;"><b>Modalidade</b></th>
                            <th style="text-align: center;"><b>Qtd horas</b></th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="tb_nomeCurso" runat="server"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tb_horario" runat="server"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tb_local" runat="server"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tb_tipo" runat="server"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tb_area" runat="server"></asp:TextBox></td>
                        <td style="text-align: center;">
                            <asp:TextBox ID="tb_modalidade" runat="server"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tb_qtdHoras" Style="text-align: center;" runat="server"></asp:TextBox></td>
                        <td>
                            <asp:TextBox ID="tb_descricao" runat="server"></asp:TextBox></td>
                        <td style="text-align: center;">
                            <asp:ImageButton ID="imgBtnEditar" ImageUrl="~/img/icon_edit.png" CommandName="imgBtnEditar" runat="server" /></td>
                        <td style="text-align: center;">
